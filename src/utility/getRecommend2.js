const getRecommend = (subtype, agedx, stage, pT, pN, ptsize,M,grade) => {
    let recommendation = '';
  
    if (subtype === 'Triple Negative' && ptsize > 20 && (stage !== '4' )) {
      recommendation = `
     ...
     Cycled every 21 days x 9 cycles\n`;
    } else if (subtype === 'Her2-enriched' && ptsize > 20 && pN !== 'pN0'  && M==='0') {
    ...
    } else if (subtype === 'Triple Negative' && (ptsize < 21&&ptsize>10) && pN === 'pN0'&& (stage !== '4' )) {
      ...
      ◊ ACx4→weekly paclitaxel x12  \n 
        ...
        Paclitaxel 80 mg/m2 by 1 h IV infusion weekly for 12 weeks.\n   
      `;
    }  else if (subtype === 'Luminal B negative'&& (ptsize > 20&&ptsize <51) && pN === 'pN0'&& grade==='Grade3') {
    ...
    }  else if (subtype === 'Luminal B negative'&& (ptsize > 20&&ptsize <51) && pN === 'pN1') {
    ...
    }else if (subtype === 'Luminal B negative'&& (ptsize > 20&&ptsize <51) && (pN === 'pN2'||pN === 'pN2'||pN === 'pN2a'||pN === 'pN2b'||pN === 'pN3'||pN === 'pN3a'||pN === 'pN3b'||pN === 'pN3c') && grade==='Grade3'&&agedx<46) {
      recommendation = `ควรให้ยานำก่อนการผ่าตัด และผ่าตัดต่อมน้ำเหลืองแบบ Axillary dissection  \n
       แนะนำใช้ Ovarian function suppression ฉีด 2-5 ปี \n
      ...
      recommendation = 'แนะนำให้ยาเคมีบำบัดนำก่อนการผ่าตัด แล้วตามด้วยการผ่าตัด';
    } else if (subtype === 'Luminal B positive' && ptsize > 20 && pN !== 'cN0' && (stage !== '4' && (stage === '3a' || stage === '3b' || stage === '3c'))) {
      recommendation = 'แนะนำให้ยาเคมีบำบัดนำก่อนการผ่าตัด ';
    } else if (subtype === 'Luminal B negative' && ptsize > 20 && pN !== 'cN0' && (stage !== '4' && (stage === '3a' || stage === '3b' || stage === '3c'))) {
